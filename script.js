function resizeFont() {
    ...
    var fontSize = Math.min(36, 0.08 * popupWidth); 
    godInfo.style.fontSize = fontSize + 'px';
    
    if (popupWidth > maxWidth) {
        var newFontSize = fontSize * (maxWidth / popupWidth);
        godInfo.style.fontSize = newFontSize + 'px';
    }
}
